...
pub mod publications {
  ...
  pub mod callback {
    ...
    pub type WriteResults<> = ::capnp::capability::Results<crate::schema::stream_capnp::stream_result::Owned>;
    ...
    impl  Client {
      pub fn write_request(&self) -> ::capnp::capability::Request<crate::schema::provider_capnp::publications::callback::write_params::Owned,crate::schema::stream_capnp::stream_result::Owned> {
        self.client.new_call(_private::TYPE_ID, 0, ::core::option::Option::None)
      }
